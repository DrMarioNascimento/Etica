# Ética Interativa — Licença de Uso Educacional Restrito

Copyright © 2026 Mário César Nascimento. Todos os direitos reservados.

## Titularidade declarada

O projeto **Ética Interativa**, incluindo seus simuladores, códigos-fonte, casos, narrativas, elementos visuais, animações, textos, organização didática e demais componentes originais, é apresentado como criação intelectual pessoal de **Mário César Nascimento**.
